========================================================================
    KONSOLENANWENDUNG: 4GewinntC-Projektübersicht
========================================================================

Diese 4GewinntC-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre 4GewinntC-Anwendung besteht.
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen 4GewinntC.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
